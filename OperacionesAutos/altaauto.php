...
<div id="content">
  <div class="container_12 bot-1">
    <div class="grid_12">
      <h2 class="indent-2">Nuevo Auto</h2>
    </div>
    <div class="grid_5">
      ...
      <form id="form" action="darAlta.php" method="POST">
        ...
        <fieldset>
          <label class="name"> <span class="title">Numero De Motor*</span>
            <input type="text" name="nmo" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid name.</span><span class="empty error-empty">*This field is required.</span> </label>

           <label class="name"> <span class="title">Placa*</span>
            <input type="text" name="placa" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid name.</span><span class="empty error-empty">*This field is required.</span> </label>

          <label class="name"> <span class="title">Marca*</span>
            <input type="text" name="marca" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid name.</span><span class="empty error-empty">*This field is required.</span> </label>
          <label class="email"> <span class="title">Modelo*</span>
            <input type="text" name="modelo" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid email address.</span><span class="empty error-empty">*This field is required.</span> </label>
          <label class="phone"> <span class="title">Color*</span>
            <input type="text" name="color" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid phone number.</span><span class="empty error-empty">*This field is required.</span> </label>
           <label class="phone"> <span class="title">Precio De Compra</span>
            <input type="text" name="precio" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid phone number.</span><span class="empty error-empty">*This field is required.</span> </label>
