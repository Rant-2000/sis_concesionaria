    ...
    <div class="container_12">      
      <div class="grid_12">
        <ul class="sf-menu">
          ...
          <li><a href="OperacionesAsignaciones/inicio.php">Asignaciones</a>
        ...
        if($_SESSION['rol'] == 1 ){
          ...
          <li><a href="Historial/inicio.php">Historial de operaciones</a>
            <ul>
...
<li><a href="Resp/inicior.php">Respaldo</a>
