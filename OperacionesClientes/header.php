    ...
    <div class="container_12">
      <div class="grid_12">
        <ul class="sf-menu">
          ...
          <li><a href="inicio.php">Clientes</a>
            <ul>
              <li><a href="altacliente.php">Nuevo Cliente</a></li>
              <li><a href="bajacliente.php">Eliminar Cliente</a></li>
              <li><a href="modibus.php">Modificar Cliente</a></li>
              <li><a href="busclie.php">Buscar Cliente</a></li>
          ...
          <li><a href="contact.html">Autos</a>
            <ul>
          ...
          <li><a href="projects.html">Ventas</a>
            <ul>
          ...
          <li><a href="contact.html">Reparaciones</a>
            <ul>
           ...
           <li><a href="Asignacion/inicio.php">Asignaciones</a>
            <ul>
              <li><a href="OperacionesClientes/altacliente.php">P. Asignacion Beta</a></li>
              <li><a href="OperacionesClientes/bajacliente.php">P. Asignacion Alfa</a></li>
              <li><a href="OperacionesClientes/modibus.php">P. Asignacion Deus</a></li>
