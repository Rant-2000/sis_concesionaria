...
<div id="content">
  <div class="container_12 bot-1">
    <div class="grid_12">
      <h2 class="indent-2">Nuevo Cliente</h2>
    </div>
    <div class="grid_5">
