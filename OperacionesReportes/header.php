  ...
  <nav>
    <div class="container_12">      
      <div class="grid_12">
        ...
        if($_SESSION['rol'] == 1 ){
            echo '
          <li><a href="../home.php">Reportes</a>
            <ul>
              <li><a href="consultaclientes.php">R. Clientes</a></li>
              <li><a href="consultainsumos">R. Insumos</a></li>
              <li><a href="consultaempleados">R. Empleados</a></li>
              <li><a href="consultaautos.php">R. Autos</a></li>
              <li><a href="consultaReparaciones.php">R. Reparaciones</a></li>
              <li><a href="consultaasignaciones.php">R. Asignaciones</a></li>
              <li><a href="consultaventas">R. Ventas</a></li>              
