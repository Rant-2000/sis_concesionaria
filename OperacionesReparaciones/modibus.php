...
<div id="content">
  <div class="container_12 bot-1">
    <div class="grid_12">
      <h2 class="indent-2">Actualizar Reparacion</h2>
    </div>
    <div class="grid_5">

      <center></center>
      <form id="form" action="modiins.php" >
        ...
        <fieldset>
            ...
            <label class="text"> <span class="title">ID Reparacion*</span>
            <input type="tel" name="idr" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid phone number.</span><span class="empty error-empty">*This field is required.</span> </label>
