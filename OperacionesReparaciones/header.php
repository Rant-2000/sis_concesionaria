      ...
      <div class="grid_12">
        <ul class="sf-menu">
          ...
          <li><a href="inicio.php">Reparaciones</a>
            <ul>
              <li><a href="altarepa.php">Nueva Reparacion</a></li>
              <li><a href="bajarepa.php">Eliminar Reparacion</a></li>
              <li><a href="modibus.php">Modificar Reparacion</a></li>
              <li><a href="buscarin.php">Buscar Reparacion</a></li>
              <li><a href="consulta.php">Consultar Reparaciones</a></li>
