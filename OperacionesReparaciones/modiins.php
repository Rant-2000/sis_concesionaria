...
?>  
        ...
        "pattern="^[a-zA-Z1-9].*" readonly='readonly'>
                    ...
                    <label class="text"> <span class="title">ID Mecanico*</span>
                    <input type="text" id="ide" name="ide" value="<?php echo ( isset ( $consultador['IDE'] ) ? $consultador['IDE'] : '' ); ?>"pattern="^[a-zA-Z1-9].*">
                    <br class="clear">
                    <span class="error error-empty">*This is not a valid phone number.</span><span class="empty error-empty">*This field is required.</span> </label>
