...
<div id="content">
  <div class="container_12 bot-1">
    <div class="grid_12">
      <h2 class="indent-2">Nuevo Producto</h2>
    </div>
    <div class="grid_5">
      ...
      <form id="form" action="darAlta.php" method="POST">
        ...
        <fieldset>
          <label class="name"> <span class="title">Nombre*</span>
            <input type="text" name="nom" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid name.</span><span class="empty error-empty">*This field is required.</span> </label>
          <label class="email"> <span class="title">Descripcion*</span>
            <input type="text" name="des" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid email address.</span><span class="empty error-empty">*This field is required.</span> </label>
          <label class="phone"> <span class="title">Precio Unitario*</span>
            <input type="text" name="pre" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid phone number.</span><span class="empty error-empty">*This field is required.</span> </label>
           <label class="phone"> <span class="title">Codigo</span>
            <input type="text" name="cod" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid phone number.</span><span class="empty error-empty">*This field is required.</span> </label>
             
             <label class="phone"> <span class="title">Cantidad*</span>
            <input type="text" name="can" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid phone number.</span><span class="empty error-empty">*This field is required.</span> </label>
          <div class="clear"></div>
