      ...
      <div class="grid_12">
        <ul class="sf-menu">
          ...
          <li><a href="contact.html">Insumos</a>
            <ul>
              <li><a href="altainsumo.php">Nuevo Producto</a></li>
              <li><a href="bajainsumo.php">Eliminar Producto</a></li>
              <li><a href="modibus.php">Modificar Producto</a></li>
              <li><a href="buscarin.php">Buscar Producto COD</a></li>
              <li><a href="consulta.php">Consultar Productos</a></li>
              <li><a href="#">Historial de Operaciones</a></li>
            </ul>
          </li>
