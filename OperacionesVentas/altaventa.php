...
<div id="content">
  <div class="container_12 bot-1">
    <div class="grid_12">
      <h2 class="indent-2">Nueva Venta</h2>
    </div>
    <div class="grid_5">
      ...
      <form id="form" action="darAlta.php" method="POST">
        ...
        <fieldset>
          <label class="name"> <span class="title">Numero de Motor*</span>
            <input type="text" name="nm" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid name.</span><span class="empty error-empty">*This field is required.</span> </label>
          <label class="email"> <span class="title">ID Cliente*</span>
            <input type="text" name="idc" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
            <span class="error error-empty">*This is not a valid email address.</span><span class="empty error-empty">*This field is required.</span> </label>
          <label class="phone"> <span class="title">Usuario Empleado*</span>
            <input type="text" name="usem" pattern="^[a-zA-Z1-9].*" >
            <br class="clear">
