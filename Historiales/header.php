...
<![endif]-->
  <script src="OperacionesAsignaciones/push.min.js"></script>
    ...
    <div class="container_12">      
      <div class="grid_12">
        <ul class="sf-menu">
          ...
          <li><a href="../OperacionesInsumos/inicio.php">Insumos</a>
            <ul>
              ...
              <li><a href="../OperacionesInsumos/modibus">Modificar Producto</a></li>
              <li><a href="../OperacionesInsumos/businsumo.php">Buscar Producto</a></li>
              <li><a href="../OperacionesInsumos/consulta.php">Consultar Productos</a></li>
              
            </ul>
          </li>
           <li><a href="../OperacionesEmpleados/inicio.php">Empleados</a>
          ...
          <li><a href="../OperacionesVentas/inicio.php">Ventas</a>
            <ul>
              ...
              <li><a href="../OperacionesVentas/busventa.php">Buscar Venta</a></li>
              <li><a href="../OperacionesVentas/consulta.php">Consultar Ventas</a></li>
             
            </ul>
          </li>
          <li><a href="../OperacionesReparaciones/inicio.php">Reparaciones</a>
            <ul>
          ...
          <li><a href="../OperacionesAsignacion/inicio.php">Asignaciones</a>
        ...
        if($_SESSION['rol'] == 1 ){
            echo '
          <li><a href="../OperacionesReportes/inicio.php">Reportes</a>
            <ul>
          ...
          <li><a href="../home.php">Historial de operaciones</a>
            <ul>
              <li><a href="hclientes.php">R. Clientes</a></li>
              <li><a href="hinsumo.php">R. Insumos</a></li>
              <li><a href="hemple.php">R. Empleados</a></li>
              <li><a href="hauto.php">R. Autos</a></li>
              <li><a href="haventas.php">R. Ventas</a></li>              
              <li><a href="hrepa.php">R. Reparaciones</a></li>
              <li><a href="hasi.php">R. Asignaciones</a></li>
            </ul> </li>'; 
        }
    }
